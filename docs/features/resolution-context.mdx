...
The <JavadocLink version={version} path="autoparams/ResolutionContext.html">`ResolutionContext`</JavadocLink> class provides the core mechanism for generating test data. While it is used internally by AutoParams, you can also instantiate and use it directly in your own test code when needed.
